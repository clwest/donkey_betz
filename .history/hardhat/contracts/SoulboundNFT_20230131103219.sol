...
contract SoulboundNFT is ERC721, ERC721URIStorage {
    ...
    function modify(
        ...
        nftMetadata[_tokenId].name = _name;
        nftMetadata[_tokenId].description = _description;
        nftMetadata[_tokenId].image = _image;
        nftMetadata[_tokenId].tags = _tags;
        nftMetadata[_tokenId].uri = _uri;
    }
