...
contract SoulboundNFT is ERC721, ERC721URIStorage {
    ...
    function mintNFT(address _to, uint256 _tokenId) public onlyOwnerAndMinter {
    ...
    // function function to set the TokenURI for the soulbound NFT
