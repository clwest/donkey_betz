...
contract Roles is AccessControl, Ownable {
    ...
    function mintSoulboundNFT(address user) public onlyRole(// new function to mint soul-bound NFTs
function mintSoulboundNFT(address user) public onlyRole(MANAGER_ROLE) {
    // your code to mint the soul-bound NFT and assign the MINTER_ROLE to the user
    // ...
    grantRole(user, MINTER_ROLE);
}) {
        // your code to mint the soul-bound NFT and assign the MINTER_ROLE to the user
        // ...
        grantRole(user, MINTER_ROLE);
